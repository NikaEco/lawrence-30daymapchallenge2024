...
const mapChallengeData = [
  ...
  { date: "06-11-2024", name: "Raster", description: "A map using raster data. Rasters are everywhere, but today's focus is purely on grids and pixels.", emoji: "🟦🟧", linkedinLink: "" },
  { date: "07-11-2024", name: "Vintage style", description: "Map something modern in a vintage aesthetic. Create a map that captures the look and feel of historical cartography but focuses on a contemporary topic.", emoji: "🕰️🗺️", linkedinLink: "" },
  { date: "08-11-2024", name: "Humanitarian Data Exchange (HDX)", description: "Use data from HDX to map humanitarian topics. Explore the datasets from the Humanitarian Data Exchange.", emoji: "🌍🚑", linkedinLink: "" },
  { date: "09-11-2024", name: "AI only", description: "This day is all about prompt engineering. Use AI tools like DALL-E, MidJourney, Stable Diffusion, or ChatGPT with geospatial capabilities to create a map.", emoji: "🤖", linkedinLink: "" },
  { date: "10-11-2024", name: "Pen & paper", description: "Draw a map by hand. Go analog and draw a map using pen and paper.", emoji: "✏️🗺️", linkedinLink: "" },
  { date: "11-11-2024", name: "Arctic", description: "Map the Arctic. Whether it's ice coverage, wildlife habitats, or the effects of climate change.", emoji: "❄️🧊", linkedinLink: "" },
  { date: "12-11-2024", name: "Time and space", description: "Map something where time matters. Visualize change over time—urban growth, migration, or environmental shifts.", emoji: "⏳🌍", linkedinLink: "" },
  { date: "13-11-2024", name: "A new tool", description: "Use a tool you've never tried before. The challenge has always been about trying new things.", emoji: "🧪🔧", linkedinLink: "" },
